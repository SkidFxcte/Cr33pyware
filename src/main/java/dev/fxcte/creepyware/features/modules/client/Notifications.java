...
public class Notifications
    ...
    public Setting<Boolean> totemPops = this.register(new Setting<Boolean>("Speed", "TotemPops", 0.0, 0.0, false, 0));
    ...
    public Setting<Boolean> clearOnLogout = this.register(new Setting<Boolean>("Speed", "LogoutClear", 0.0, 0.0, false, 0));
    public Setting<Boolean> moduleMessage = this.register(new Setting<Boolean>("Speed", "ModuleMessage", 0.0, 0.0, false, 0));
    ...
    public Setting<Boolean> visualRange = this.register(new Setting<Boolean>("Speed", "VisualRange", 0.0, 0.0, false, 0));
    public Setting<Boolean> VisualRangeSound = this.register(new Setting<Boolean>("Speed", "VisualRangeSound", 0.0, 0.0, false, 0));
    ...
    public Setting<Boolean> pearls = this.register(new Setting<Boolean>("Speed", "PearlNotifs", 0.0, 0.0, false, 0));
    public Setting<Boolean> crash = this.register(new Setting<Boolean>("Speed", "Crash", 0.0, 0.0, false, 0));
    public Setting<Boolean> popUp = this.register(new Setting<Boolean>("Speed", "PopUpVisualRange", 0.0, 0.0, false, 0));
    ...
    public TextComponentString getNotifierOn(Module module) {
        if (ModuleTools.getInstance().isEnabled()) {
            switch (ModuleTools.getInstance().notifier.getValue()) {
                ...
                case PHOBOS: {
                    TextComponentString text = new TextComponentString((CreepyWare.commandManager.getClientMessage()) + ChatFormatting.BOLD + module.getDisplayName() + ChatFormatting.RESET + ChatFormatting.GREEN + " enabled.");
                    return text;

                }
            }
        }
        TextComponentString text = new TextComponentString(CreepyWare.commandManager.getClientMessage() + ChatFormatting.GREEN + module.getDisplayName() + " toggled on.");
        return text;
    }
    ...
    public TextComponentString getNotifierOff(Module module) {
        if (ModuleTools.getInstance().isEnabled()) {
            switch (ModuleTools.getInstance().notifier.getValue()) {
                ...
                case PHOBOS: {
                    TextComponentString text = new TextComponentString((CreepyWare.commandManager.getClientMessage()) + ChatFormatting.BOLD + module.getDisplayName() + ChatFormatting.RESET + ChatFormatting.RED + " disabled.");
                    return text;

                }
            }
        }
        TextComponentString text = new TextComponentString(CreepyWare.commandManager.getClientMessage() + ChatFormatting.RED + module.getDisplayName() + " toggled off.");
        return text;
    }
