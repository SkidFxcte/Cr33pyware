...
public class HoleESP
    ...
    public Setting<Boolean> ownHole = this.register(new Setting <> ("Speed" , "OwnHole" , 0.0 , 0.0 , false , 0));
    public Setting<Boolean> box = this.register(new Setting <> ("Speed" , "Box" , 0.0 , 0.0 , true , 0));
    public Setting<Boolean> gradientBox = this.register(new Setting<Object>("GradientBox", false , v -> this.box.getValue()));
    public Setting<Boolean> pulseAlpha = this.register(new Setting<Object>("PulseAlpha", false , v -> this.gradientBox.getValue()));
    public Setting<Boolean> pulseOutline = this.register(new Setting<Object>("PulseOutline", true , v -> this.gradientBox.getValue()));
    public Setting<Boolean> invertGradientBox = this.register(new Setting<Object>("InvertGradientBox", false , v -> this.gradientBox.getValue()));
    public Setting<Boolean> outline = this.register(new Setting <> ("Speed" , "Outline" , 0.0 , 0.0 , true , 0));
    public Setting<Boolean> gradientOutline = this.register(new Setting<Object>("GradientOutline", false , v -> this.outline.getValue()));
    public Setting<Boolean> invertGradientOutline = this.register(new Setting<Object>("InvertGradientOutline", false , v -> this.gradientOutline.getValue()));
    public Setting<Double> height = this.register(new Setting <> ("Height" , 0.0 , - 2.0 , 2.0));
    public Setting<Boolean> safeColor = this.register(new Setting <> ("Speed" , "SafeColor" , 0.0 , 0.0 , false , 0));
    ...
    private final Setting<Integer> safecRed = this.register(new Setting<Object>("OL-SafeRed", 0 , 0 , 255 , v -> this.customOutline.getValue() != false && this.outline.getValue() != false && this.safeColor.getValue() != false));
    private final Setting<Integer> safecGreen = this.register(new Setting<Object>("OL-SafeGreen", 255 , 0 , 255 , v -> this.customOutline.getValue() != false && this.outline.getValue() != false && this.safeColor.getValue() != false));
    private final Setting<Integer> safecBlue = this.register(new Setting<Object>("OL-SafeBlue", 0 , 0 , 255 , v -> this.customOutline.getValue() != false && this.outline.getValue() != false && this.safeColor.getValue() != false));
    private final Setting<Integer> safecAlpha = this.register(new Setting<Object>("OL-SafeAlpha", 255 , 0 , 255 , v -> this.customOutline.getValue() != false && this.outline.getValue() != false && this.safeColor.getValue() != false));
    ...
    public void onRender3D(Render3DEvent event) {
        ...
        for (BlockPos pos : CreepyWare.holeManager.getSortedHoles()) {
