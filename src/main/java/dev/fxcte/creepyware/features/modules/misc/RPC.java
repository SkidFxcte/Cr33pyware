...
public class RPC extends Module {
    ...
    public Setting<Boolean> showIP = this.register(new Setting<Boolean>("Speed", "IP", 0.0, 0.0, false, 0));
    public Setting<Boolean> users = this.register(new Setting<Boolean>("Speed", "Users", 0.0, 0.0, false, 0));
