...
public class ServerModule
    ...
    public Setting<String> ip = this.register(new Setting<String>("Speed", "0.0.0.0.0"));
    public Setting<String> port = this.register(new Setting<String>("Speed", "0").setRenderName(true));
    public Setting<String> serverIP = this.register(new Setting<String>("Speed", "AnarchyHvH.eu"));
    public Setting<Boolean> noFML = this.register(new Setting<Boolean>("Speed", false));
    public Setting<Boolean> getName = this.register(new Setting<Boolean>("Speed", false));
    public Setting<Boolean> average = this.register(new Setting<Boolean>("Speed", false));
    public Setting<Boolean> clear = this.register(new Setting<Boolean>("Speed", false));
    public Setting<Boolean> oneWay = this.register(new Setting<Boolean>("Speed", false));
