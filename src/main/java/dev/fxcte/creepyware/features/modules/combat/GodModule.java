...
public class GodModule
    ...
    public Setting<Boolean> rotate = this.register(new Setting <> ("Speed" , "Rotate" , 0.0 , 0.0 , false , 0));
    public Setting<Boolean> render = this.register(new Setting <> ("Speed" , "Render" , 0.0 , 0.0 , false , 0));
    public Setting<Boolean> antiIllegal = this.register(new Setting <> ("Speed" , "AntiIllegal" , 0.0 , 0.0 , true , 0));
    public Setting<Boolean> checkPos = this.register(new Setting <> ("Speed" , "CheckPos" , 0.0 , 0.0 , true , 0));
    public Setting<Boolean> oneDot15 = this.register(new Setting <> ("Speed" , "1.15" , 0.0 , 0.0 , false , 0));
    public Setting<Boolean> entitycheck = this.register(new Setting <> ("Speed" , "EntityCheck" , 0.0 , 0.0 , false , 0));
