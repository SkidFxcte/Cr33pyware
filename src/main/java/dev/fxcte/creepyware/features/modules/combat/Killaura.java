...
public class Killaura
    ...
    public Setting<Boolean> autoSwitch = this.register(new Setting<Boolean>("Speed", false));
    public Setting<Boolean> delay = this.register(new Setting<Boolean>("Speed", true));
    public Setting<Boolean> rotate = this.register(new Setting<Boolean>("Speed", true));
    public Setting<Boolean> stay = this.register(new Setting<Object>("Stay", Boolean.valueOf(true), v -> this.rotate.getValue()));
    public Setting<Boolean> armorBreak = this.register(new Setting<Boolean>("Speed", false));
    public Setting<Boolean> eating = this.register(new Setting<Boolean>("Speed", true));
    public Setting<Boolean> onlySharp = this.register(new Setting<Boolean>("Speed", true));
    public Setting<Boolean> teleport = this.register(new Setting<Boolean>("Speed", false));
    ...
    public Setting<Boolean> teekaydelay = this.register(new Setting<Boolean>("Speed", false));
    ...
    public Setting<Boolean> multi32k = this.register(new Setting<Boolean>("Speed", false));
    public Setting<Boolean> players = this.register(new Setting<Boolean>("Speed", true));
    public Setting<Boolean> mobs = this.register(new Setting<Boolean>("Speed", false));
    public Setting<Boolean> animals = this.register(new Setting<Boolean>("Speed", false));
    public Setting<Boolean> vehicles = this.register(new Setting<Boolean>("Speed", false));
    public Setting<Boolean> projectiles = this.register(new Setting<Boolean>("Speed", false));
    public Setting<Boolean> tps = this.register(new Setting<Boolean>("Speed", true));
    public Setting<Boolean> packet = this.register(new Setting<Boolean>("Speed", false));
    public Setting<Boolean> swing = this.register(new Setting<Boolean>("Speed", true));
    public Setting<Boolean> sneak = this.register(new Setting<Boolean>("Speed", false));
    public Setting<Boolean> info = this.register(new Setting<Boolean>("Speed", true));
    private final Setting<TargetMode> targetMode = this.register(new Setting<TargetMode>("Speed", TargetMode.CLOSEST));
