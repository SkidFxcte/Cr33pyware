...
public class HoleFiller
    ...
    private final Setting<Boolean> webSelf = this.register(new Setting<Boolean>("Speed", false));
    ...
    private final Setting<Boolean> midSafeHoles = this.register(new Setting<Boolean>("Speed", false));
    private final Setting<Boolean> packet = this.register(new Setting<Boolean>("Speed", false));
    private final Setting<Boolean> onGroundCheck = this.register(new Setting<Boolean>("Speed", false));
    ...
    public Setting<PlaceMode> placeMode = this.register(new Setting<PlaceMode>("Speed", PlaceMode.ALL));
