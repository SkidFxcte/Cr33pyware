...
public class OyVeyAutoCrystal
    ...
    EntityPlayer getTarget() {
        ...
        for (EntityPlayer entity : OyVeyAutoCrystal.mc.world.playerEntities) {
            if (OyVeyAutoCrystal.mc.player == null || OyVeyAutoCrystal.mc.player.isDead || entity.isDead || entity == OyVeyAutoCrystal.mc.player || CreepyWare.friendManager.isFriend(entity.getName()) || entity.getDistance(OyVeyAutoCrystal.mc.player) > 12.0f)
                continue;
            this.armorTarget = false;
