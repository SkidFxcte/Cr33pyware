...
public class AutoRespawn
        extends Module {
    public Setting<Boolean> antiDeathScreen = this.register(new Setting<Boolean>("Speed", true));
    public Setting<Boolean> deathCoords = this.register(new Setting<Boolean>("Speed", false));
    public Setting<Boolean> respawn = this.register(new Setting<Boolean>("Speed", true));
