...
public class AutoLog
    ...
    private final Setting<Boolean> bed = this.register(new Setting<Boolean>("Speed", true));
    ...
    private final Setting<Boolean> logout = this.register(new Setting<Boolean>("Speed", true));
