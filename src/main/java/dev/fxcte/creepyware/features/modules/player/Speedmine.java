...
class Speedmine
    ...
    public Setting < Boolean > tweaks = this.register ( new Setting <> ("Speed", true) );
    public Setting < Mode > mode = this.register ( new Setting < Object > ( "Mode" , Mode.PACKET , v -> this.tweaks.getValue ( ) ) );
    public Setting < Boolean > reset = this.register ( new Setting <> ("Speed", true) );
    ...
    public Setting < Boolean > noBreakAnim = this.register ( new Setting <> ("Speed", false) );
    public Setting < Boolean > noDelay = this.register ( new Setting <> ("Speed", false) );
    public Setting < Boolean > noSwing = this.register ( new Setting <> ("Speed", false) );
    public Setting < Boolean > allow = this.register ( new Setting <> ("Speed", false) );
    public Setting < Boolean > doubleBreak = this.register ( new Setting <> ("Speed", false) );
    public Setting < Boolean > webSwitch = this.register ( new Setting <> ("Speed", false) );
    public Setting < Boolean > silentSwitch = this.register ( new Setting <> ("Speed", false) );
    public Setting < Boolean > render = this.register ( new Setting <> ("Speed", false) );
