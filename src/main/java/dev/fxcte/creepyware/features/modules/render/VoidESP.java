...
public class VoidESP
    ...
    public Setting<Boolean> air = this.register(new Setting <> ("Speed" , "OnlyAir" , 0.0 , 0.0 , true , 0));
    public Setting<Boolean> noEnd = this.register(new Setting <> ("Speed" , "NoEnd" , 0.0 , 0.0 , true , 0));
