...
public class Nametags
    ...
    private final Setting<Boolean> health = this.register(new Setting<Boolean>("Speed", true));
    private final Setting<Boolean> armor = this.register(new Setting<Boolean>("Speed", true));
    ...
    private final Setting<Boolean> invisibles = this.register(new Setting<Boolean>("Speed", false));
    private final Setting<Boolean> ping = this.register(new Setting<Boolean>("Speed", true));
    private final Setting<Boolean> totemPops = this.register(new Setting<Boolean>("Speed", true));
    private final Setting<Boolean> gamemode = this.register(new Setting<Boolean>("Speed", false));
    private final Setting<Boolean> entityID = this.register(new Setting<Boolean>("Speed", false));
    private final Setting<Boolean> rect = this.register(new Setting<Boolean>("Speed", true));
    ...
    private final Setting<Boolean> sneak = this.register(new Setting<Boolean>("Speed", false));
    private final Setting<Boolean> heldStackName = this.register(new Setting<Boolean>("Speed", false));
    private final Setting<Boolean> whiter = this.register(new Setting<Boolean>("Speed", false));
    private final Setting<Boolean> onlyFov = this.register(new Setting<Boolean>("Speed", false));
    private final Setting<Boolean> scaleing = this.register(new Setting<Boolean>("Speed", false));
    ...
    private String getDisplayTag(EntityPlayer player) {
        ...
        if (this.totemPops.getValue().booleanValue()) {
            popStr = popStr + CreepyWare.totemPopManager.getTotemPopString(player);
        }
        String idString = "";
