...
class AutoCrystal
    ...
    // PLACE SETTINGS
    public Setting < Boolean > place = this.register ( new Setting < Object > ( "Place" , true , v -> this.setting.getValue ( ) == Settings.PLACE ) );
    ...
    public Setting < Boolean > wasteMinDmgCount = this.register ( new Setting < Object > ( "CountMinDmg" , true , v -> this.setting.getValue ( ) == Settings.PLACE && this.place.getValue ( ) ) );
    ...
    public Setting < Boolean > antiSurround = this.register ( new Setting < Object > ( "AntiSurround" , true , v -> this.setting.getValue ( ) == Settings.PLACE && this.place.getValue ( ) ) );
    public Setting < Boolean > limitFacePlace = this.register ( new Setting < Object > ( "LimitFacePlace" , true , v -> this.setting.getValue ( ) == Settings.PLACE && this.place.getValue ( ) ) );
    public Setting < Boolean > oneDot15 = this.register ( new Setting < Object > ( "1.15" , false , v -> this.setting.getValue ( ) == Settings.PLACE && this.place.getValue ( ) ) );
    public Setting < Boolean > doublePop = this.register ( new Setting < Object > ( "AntiTotem" , false , v -> this.setting.getValue ( ) == Settings.PLACE && this.place.getValue ( ) ) );
    ...
    public Setting < Boolean > doublePopOnDamage = this.register ( new Setting < Object > ( "DamagePop" , false , v -> this.setting.getValue ( ) == Settings.PLACE && this.place.getValue ( ) && this.doublePop.getValue ( ) && this.targetMode.getValue ( ) == Target.DAMAGE ) );
    // BREAK SETTINGS
    public Setting < Boolean > explode = this.register ( new Setting < Object > ( "Break" , true , v -> this.setting.getValue ( ) == Settings.BREAK ) );
    ...
    public Setting < Boolean > manual = this.register ( new Setting < Object > ( "Manual" , true , v -> this.setting.getValue ( ) == Settings.BREAK ) );
    public Setting < Boolean > manualMinDmg = this.register ( new Setting < Object > ( "ManMinDmg" , true , v -> this.setting.getValue ( ) == Settings.BREAK && this.manual.getValue ( ) ) );
    ...
    public Setting < Boolean > sync = this.register ( new Setting < Object > ( "Sync" , true , v -> this.setting.getValue ( ) == Settings.BREAK && ( this.explode.getValue ( ) || this.manual.getValue ( ) ) ) );
    public Setting < Boolean > instant = this.register ( new Setting < Object > ( "Predict" , true , v -> this.setting.getValue ( ) == Settings.BREAK && this.explode.getValue ( ) && this.place.getValue ( ) ) );
    ...
    public Setting < Boolean > resetBreakTimer = this.register ( new Setting < Object > ( "ResetBreakTimer" , true , v -> this.setting.getValue ( ) == Settings.BREAK && this.explode.getValue ( ) && this.place.getValue ( ) && this.instant.getValue ( ) ) );
    ...
    public Setting < Boolean > predictCalc = this.register ( new Setting < Object > ( "PredictCalc" , true , v -> this.setting.getValue ( ) == Settings.BREAK && this.explode.getValue ( ) && this.place.getValue ( ) && this.instant.getValue ( ) ) );
    public Setting < Boolean > superSafe = this.register ( new Setting < Object > ( "SuperSafe" , true , v -> this.setting.getValue ( ) == Settings.BREAK && this.explode.getValue ( ) && this.place.getValue ( ) && this.instant.getValue ( ) ) );
    public Setting < Boolean > antiCommit = this.register ( new Setting < Object > ( "AntiOverCommit" , true , v -> this.setting.getValue ( ) == Settings.BREAK && this.explode.getValue ( ) && this.place.getValue ( ) && this.instant.getValue ( ) ) );
    // RENDER SETTINGS
    ...
    public Setting < Boolean > holdFacePlace = this.register ( new Setting < Object > ( "HoldFacePlace" , false , v -> this.setting.getValue ( ) == Settings.MISC ) );
    public Setting < Boolean > holdFaceBreak = this.register ( new Setting < Object > ( "HoldSlowBreak" , false , v -> this.setting.getValue ( ) == Settings.MISC && this.holdFacePlace.getValue ( ) ) );
    public Setting < Boolean > slowFaceBreak = this.register ( new Setting < Object > ( "SlowFaceBreak" , false , v -> this.setting.getValue ( ) == Settings.MISC ) );
    public Setting < Boolean > actualSlowBreak = this.register ( new Setting < Object > ( "ActuallySlow" , false , v -> this.setting.getValue ( ) == Settings.MISC ) );
    ...
    public Setting < Boolean > antiNaked = this.register ( new Setting < Object > ( "AntiNaked" , true , v -> this.setting.getValue ( ) == Settings.MISC ) );
    ...
    public Setting < Boolean > offhandSwitch = this.register ( new Setting < Object > ( "Offhand" , true , v -> this.setting.getValue ( ) == Settings.MISC && this.autoSwitch.getValue ( ) != AutoSwitch.NONE && this.autoSwitch.getValue ( ) != AutoSwitch.SILENT ) );
    public Setting < Boolean > switchBack = this.register ( new Setting < Object > ( "Switchback" , true , v -> this.setting.getValue ( ) == Settings.MISC && this.autoSwitch.getValue ( ) != AutoSwitch.NONE && this.offhandSwitch.getValue ( ) && this.autoSwitch.getValue ( ) != AutoSwitch.SILENT ) );
    public Setting < Boolean > lethalSwitch = this.register ( new Setting < Object > ( "LethalSwitch" , false , v -> this.setting.getValue ( ) == Settings.MISC && this.autoSwitch.getValue ( ) != AutoSwitch.NONE && this.autoSwitch.getValue ( ) != AutoSwitch.SILENT ) );
    public Setting < Boolean > mineSwitch = this.register ( new Setting < Object > ( "MineSwitch" , true , v -> this.setting.getValue ( ) == Settings.MISC && this.autoSwitch.getValue ( ) != AutoSwitch.NONE && this.autoSwitch.getValue ( ) != AutoSwitch.SILENT ) );
    public Setting < Rotate > rotate = this.register ( new Setting < Object > ( "Rotate" , Rotate.OFF , v -> this.setting.getValue ( ) == Settings.MISC ) );
    public Setting < Boolean > suicide = this.register ( new Setting < Object > ( "Suicide" , false , v -> this.setting.getValue ( ) == Settings.MISC ) );
    public Setting < Boolean > webAttack = this.register ( new Setting < Object > ( "WebAttack" , true , v -> this.setting.getValue ( ) == Settings.MISC && this.targetMode.getValue ( ) != Target.DAMAGE ) );
    public Setting < Boolean > fullCalc = this.register ( new Setting < Object > ( "ExtraCalc" , false , v -> this.setting.getValue ( ) == Settings.MISC ) );
    public Setting < Boolean > sound = this.register ( new Setting < Object > ( "Sound" , true , v -> this.setting.getValue ( ) == Settings.MISC ) );
    ...
    public Setting < Boolean > soundConfirm = this.register ( new Setting < Object > ( "SoundConfirm" , true , v -> this.setting.getValue ( ) == Settings.MISC ) );
    public Setting < Boolean > extraSelfCalc = this.register ( new Setting < Object > ( "MinSelfDmg" , false , v -> this.setting.getValue ( ) == Settings.MISC ) );
    ...
    public Setting < Boolean > noCount = this.register ( new Setting < Object > ( "AntiCount" , false , v -> this.setting.getValue ( ) == Settings.MISC && ( this.antiFriendPop.getValue ( ) == AntiFriendPop.ALL || this.antiFriendPop.getValue ( ) == AntiFriendPop.BREAK ) ) );
    public Setting < Boolean > calcEvenIfNoDamage = this.register ( new Setting < Object > ( "BigFriendCalc" , false , v -> this.setting.getValue ( ) == Settings.MISC && ( this.antiFriendPop.getValue ( ) == AntiFriendPop.ALL || this.antiFriendPop.getValue ( ) == AntiFriendPop.BREAK ) && this.targetMode.getValue ( ) != Target.DAMAGE ) );
    public Setting < Boolean > predictFriendDmg = this.register ( new Setting < Object > ( "PredictFriend" , false , v -> this.setting.getValue ( ) == Settings.MISC && ( this.antiFriendPop.getValue ( ) == AntiFriendPop.ALL || this.antiFriendPop.getValue ( ) == AntiFriendPop.BREAK ) && this.instant.getValue ( ) ) );
    ...
    public final Setting < Boolean > attackOppositeHand = this.register ( new Setting < Object > ( "OppositeHand" , false , v -> this.setting.getValue ( ) == Settings.DEV ) );
    public final Setting < Boolean > removeAfterAttack = this.register ( new Setting < Object > ( "AttackRemove" , false , v -> this.setting.getValue ( ) == Settings.DEV ) );
    public final Setting < Boolean > antiBlock = this.register ( new Setting < Object > ( "AntiFeetPlace" , false , v -> this.setting.getValue ( ) == Settings.DEV ) );
    ...
    public Setting < Boolean > breakSwing = this.register ( new Setting < Object > ( "BreakSwing" , true , v -> this.setting.getValue ( ) == Settings.DEV ) );
    public Setting < Boolean > placeSwing = this.register ( new Setting < Object > ( "PlaceSwing" , false , v -> this.setting.getValue ( ) == Settings.DEV ) );
    public Setting < Boolean > exactHand = this.register ( new Setting < Object > ( "ExactHand" , false , v -> this.setting.getValue ( ) == Settings.DEV && this.placeSwing.getValue ( ) ) );
    public Setting < Boolean > fakeSwing = this.register ( new Setting < Object > ( "FakeSwing" , false , v -> this.setting.getValue ( ) == Settings.DEV && this.justRender.getValue ( ) ) );
    ...
    public Setting < Boolean > syncedFeetPlace = this.register ( new Setting < Object > ( "FeetSync" , false , v -> this.setting.getValue ( ) == Settings.DEV && this.damageSync.getValue ( ) != DamageSync.NONE ) );
    public Setting < Boolean > fullSync = this.register ( new Setting < Object > ( "FullSync" , false , v -> this.setting.getValue ( ) == Settings.DEV && this.damageSync.getValue ( ) != DamageSync.NONE && this.syncedFeetPlace.getValue ( ) ) );
    public Setting < Boolean > syncCount = this.register ( new Setting < Object > ( "SyncCount" , true , v -> this.setting.getValue ( ) == Settings.DEV && this.damageSync.getValue ( ) != DamageSync.NONE && this.syncedFeetPlace.getValue ( ) ) );
    public Setting < Boolean > hyperSync = this.register ( new Setting < Object > ( "HyperSync" , false , v -> this.setting.getValue ( ) == Settings.DEV && this.damageSync.getValue ( ) != DamageSync.NONE && this.syncedFeetPlace.getValue ( ) ) );
    public Setting < Boolean > gigaSync = this.register ( new Setting < Object > ( "GigaSync" , false , v -> this.setting.getValue ( ) == Settings.DEV && this.damageSync.getValue ( ) != DamageSync.NONE && this.syncedFeetPlace.getValue ( ) ) );
    public Setting < Boolean > syncySync = this.register ( new Setting < Object > ( "SyncySync" , false , v -> this.setting.getValue ( ) == Settings.DEV && this.damageSync.getValue ( ) != DamageSync.NONE && this.syncedFeetPlace.getValue ( ) ) );
    public Setting < Boolean > enormousSync = this.register ( new Setting < Object > ( "EnormousSync" , false , v -> this.setting.getValue ( ) == Settings.DEV && this.damageSync.getValue ( ) != DamageSync.NONE && this.syncedFeetPlace.getValue ( ) ) );
    public Setting < Boolean > holySync = this.register ( new Setting < Object > ( "UnbelievableSync" , false , v -> this.setting.getValue ( ) == Settings.DEV && this.damageSync.getValue ( ) != DamageSync.NONE && this.syncedFeetPlace.getValue ( ) ) );
    public Setting < Boolean > rotateFirst = this.register ( new Setting < Object > ( "FirstRotation" , false , v -> this.setting.getValue ( ) == Settings.DEV && this.rotate.getValue ( ) != Rotate.OFF && this.eventMode.getValue ( ) == 2 ) );
    ...
    public Setting < Boolean > syncThreadBool = this.register ( new Setting < Object > ( "ThreadSync" , true , v -> this.setting.getValue ( ) == Settings.DEV && this.threadMode.getValue ( ) != ThreadMode.NONE ) );
    ...
    public Setting < Boolean > predictPos = this.register ( new Setting < Object > ( "PredictPos" , false , v -> this.setting.getValue ( ) == Settings.DEV ) );
    ...
    public Setting < Boolean > predictRotate = this.register ( new Setting < Object > ( "PredictRotate" , false , v -> this.setting.getValue ( ) == Settings.DEV ) );
            ...
            if ( packet2.getType ( ) == 51 && AutoCrystal.mc.player.getDistanceSq ( pos = new BlockPos ( packet2.getX ( ) , packet2.getY ( ) , packet2.getZ ( ) ) ) + (double) this.predictOffset.getValue ( ) <= MathUtil.square ( this.breakRange.getValue ( ) ) && ( this.instantTimer.getValue ( ) == PredictTimer.NONE || this.instantTimer.getValue ( ) == PredictTimer.BREAK && this.breakTimer.passedMs ( this.breakDelay.getValue ( ) ) || this.instantTimer.getValue ( ) == PredictTimer.PREDICT && this.predictTimer.passedMs ( this.predictDelay.getValue ( ) ) ) ) {
                ...
                if ( this.predictFriendDmg.getValue ( ) && ( this.antiFriendPop.getValue ( ) == AntiFriendPop.BREAK || this.antiFriendPop.getValue ( ) == AntiFriendPop.ALL ) && this.isRightThread ( ) ) {
                    for (EntityPlayer friend : AutoCrystal.mc.world.playerEntities) {
                        if ( friend == null || AutoCrystal.mc.player.equals ( friend ) || friend.getDistanceSq ( pos ) > MathUtil.square ( this.range.getValue ( ) + this.placeRange.getValue ( ) ) || ! CreepyWare.friendManager.isFriend ( friend ) || ! ( (double) DamageUtil.calculateDamage ( pos , friend ) > (double) EntityUtil.getHealth ( friend ) + 0.5 ) )
                            continue;
                        return;
                    }
                }
    ...
    boolean isRightThread ( ) {
        return mc.isCallingFromMinecraftThread ( ) || ! CreepyWare.eventManager.ticksOngoing ( ) && ! this.threadOngoing.get ( );
    }
        ...
        for (Entity entity : AutoCrystal.mc.world.loadedEntityList) {
            ...
            if ( (double) selfDamage + 0.5 < (double) EntityUtil.getHealth ( AutoCrystal.mc.player ) && selfDamage <= this.maxSelfBreak.getValue ( ) ) {
                ...
                for (EntityPlayer player : AutoCrystal.mc.world.playerEntities) {
                    ...
                    if ( this.antiFriendPop.getValue ( ) != AntiFriendPop.BREAK && this.antiFriendPop.getValue ( ) != AntiFriendPop.ALL || ! CreepyWare.friendManager.isFriend ( player.getName ( ) ) || ! ( (double) DamageUtil.calculateDamage ( entity , player ) > (double) EntityUtil.getHealth ( player ) + 0.5 ) )
                        continue;
