...
class CrystalChams
    ...
    void onRenderModel ( RenderEntityModelEvent event ) {
        ...
        Color color = this.colorSync.getValue ( ) ? ClientColors.INSTANCE.getCurrentColor ( ) : EntityUtil.getColor ( event.entity , this.red.getValue ( ) , this.green.getValue ( ) , this.blue.getValue ( ) , this.alpha.getValue ( ) , false );
