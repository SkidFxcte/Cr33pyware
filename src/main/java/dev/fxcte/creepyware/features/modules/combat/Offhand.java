...
public class Offhand
    ...
    public Setting<Type> type = this.register(new Setting<Type>("Speed", "Mode", 0.0, 0.0, Type.NEW, 0));
    ...
    public Setting<Bind> offHandGapple = this.register(new Setting<Bind>("Speed", "Gapple", 0.0, 0.0, new Bind(-1), 0));
    ...
    public Setting<Bind> offHandCrystal = this.register(new Setting<Bind>("Speed", "Crystal", 0.0, 0.0, new Bind(-1), 0));
    ...
    public Setting<Bind> obsidian = this.register(new Setting<Bind>("Speed", "Obsidian", 0.0, 0.0, new Bind(-1), 0));
    ...
    public Setting<Boolean> holeCheck = this.register(new Setting<Boolean>("Speed", "Hole-Check", 0.0, 0.0, true, 0));
    public Setting<Boolean> crystalCheck = this.register(new Setting<Boolean>("Speed", "Crystal-Check", 0.0, 0.0, false, 0));
    public Setting<Boolean> gapSwap = this.register(new Setting<Boolean>("Speed", "Gap-Swap", 0.0, 0.0, true, 0));
    ...
    public Setting<Boolean> noOffhandGC = this.register(new Setting<Boolean>("Speed", "NoOGC", 0.0, 0.0, false, 0));
    public Setting<Boolean> retardOGC = this.register(new Setting<Boolean>("Speed", "RetardOGC", 0.0, 0.0, false, 0));
    public Setting<Boolean> returnToCrystal = this.register(new Setting<Boolean>("Speed", "RecoverySwitch", 0.0, 0.0, false, 0));
    ...
    public Setting<Boolean> guis = this.register(new Setting<Boolean>("Speed", "Guis", 0.0, 0.0, false, 0));
    public Setting<Integer> serverTimeOut = this.register(new Setting<Integer>("S-Timeout", 1000, 0, 5000));
    public Setting<Boolean> bedcheck = this.register(new Setting<Boolean>("Speed", "BedCheck", 0.0, 0.0, false, 0));
    ...
    private boolean noNearbyPlayers() {
        return this.mode == Mode.CRYSTALS && Offhand.mc.world.playerEntities.stream().noneMatch(e -> e != Offhand.mc.player && !CreepyWare.friendManager.isFriend(e) && Offhand.mc.player.getDistance(e) <= this.cTargetDistance.getValue().floatValue());
    }
