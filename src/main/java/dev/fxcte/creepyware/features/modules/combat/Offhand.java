...
public class Offhand
    ...
    public Setting<Type> type = this.register(new Setting<Type>("Speed", Type.NEW));
    ...
    public Setting<Bind> offHandGapple = this.register(new Setting<Bind>("Speed", new Bind(-1)));
    ...
    public Setting<Bind> offHandCrystal = this.register(new Setting<Bind>("Speed", new Bind(-1)));
    ...
    public Setting<Bind> obsidian = this.register(new Setting<Bind>("Speed", new Bind(-1)));
    ...
    public Setting<Boolean> holeCheck = this.register(new Setting<Boolean>("Speed", true));
    public Setting<Boolean> crystalCheck = this.register(new Setting<Boolean>("Speed", false));
    public Setting<Boolean> gapSwap = this.register(new Setting<Boolean>("Speed", true));
    ...
    public Setting<Boolean> noOffhandGC = this.register(new Setting<Boolean>("Speed", false));
    public Setting<Boolean> retardOGC = this.register(new Setting<Boolean>("Speed", false));
    public Setting<Boolean> returnToCrystal = this.register(new Setting<Boolean>("Speed", false));
    ...
    public Setting<Boolean> guis = this.register(new Setting<Boolean>("Speed", false));
    public Setting<Integer> serverTimeOut = this.register(new Setting<Integer>("S-Timeout", 1000, 0, 5000));
    public Setting<Boolean> bedcheck = this.register(new Setting<Boolean>("Speed", false));
