...
public class Offhand
    ...
    public Setting<Boolean> onlyWTotem = this.register(new Setting<Object>("OnlyWTotem", Boolean.TRUE , v -> this.autoGapple.getValue() != false && this.type.getValue() == Type.OLD));
