...
class XCarry
    ...
    private final Setting <Boolean> simpleMode = this.register(new Setting <>("Speed", "Simple", 0.0, 0.0, false, 0));
    private final Setting <Bind> autoStore = this.register(new Setting <>("Speed", "AutoDuel", 0.0, 0.0, new Bind(- 1), 0));
