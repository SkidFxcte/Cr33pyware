...
public class XCarry
    ...
    private final Setting<Boolean> simpleMode = this.register(new Setting<Boolean>("Speed", false));
    private final Setting<Bind> autoStore = this.register(new Setting<Bind>("Speed", new Bind(-1)));
    ...
    private final Setting<Boolean> store = this.register(new Setting<Boolean>("Speed", false));
    private final Setting<Boolean> shiftClicker = this.register(new Setting<Boolean>("Speed", false));
