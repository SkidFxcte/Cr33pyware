...
public class LogoutSpots
    ...
    private final Setting<Boolean> coords = this.register(new Setting<Boolean>("Speed", true));
    private final Setting<Boolean> notification = this.register(new Setting<Boolean>("Speed", true));
    ...
    public Setting<Boolean> message = this.register(new Setting<Boolean>("Speed", false));
