...
class Replenish
    ...
    private final Setting <Boolean> pauseInv = this.register(new Setting <>("Speed", "PauseInv", 0.0, 0.0, true, 0));
    private final Setting <Boolean> putBack = this.register(new Setting <>("Speed", "PutBack", 0.0, 0.0, true, 0));
