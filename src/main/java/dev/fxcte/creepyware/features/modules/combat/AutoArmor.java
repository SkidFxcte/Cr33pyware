...
public class AutoArmor
    ...
    public void onTick() {
        ...
        if (this.timer.passedMs((int) ((float) this.delay.getValue().intValue() * CreepyWare.serverManager.getTpsFactor()))) {
            if (!this.taskList.isEmpty()) {
