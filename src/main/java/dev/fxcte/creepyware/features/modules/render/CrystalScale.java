...
public class CrystalScale
    ...
    public Setting<Boolean> animateScale = this.register(new Setting<Boolean>("Speed", false));
    public Setting<Boolean> chams = this.register(new Setting<Boolean>("Speed", false));
    public Setting<Boolean> throughWalls = this.register(new Setting<Boolean>("Speed", true));
    public Setting<Boolean> wireframeThroughWalls = this.register(new Setting<Boolean>("Speed", true));
    public Setting<Boolean> glint = this.register(new Setting<Object>("Glint", Boolean.valueOf(false), v -> this.chams.getValue()));
    public Setting<Boolean> wireframe = this.register(new Setting<Boolean>("Speed", false));
    ...
    public Setting<Boolean> rainbow = this.register(new Setting<Boolean>("Speed", false));
