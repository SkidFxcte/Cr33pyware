...
public class Strafe
    ...
    private final Setting<Mode> mode = this.register(new Setting<Mode>("Speed", Mode.NCP));
    private final Setting<Boolean> limiter = this.register(new Setting<Boolean>("Speed", true));
    private final Setting<Boolean> bhop2 = this.register(new Setting<Boolean>("Speed", true));
    private final Setting<Boolean> limiter2 = this.register(new Setting<Boolean>("Speed", false));
    private final Setting<Boolean> noLag = this.register(new Setting<Boolean>("Speed", false));
    ...
    private final Setting<Boolean> potion = this.register(new Setting<Boolean>("Speed", false));
    private final Setting<Boolean> wait = this.register(new Setting<Boolean>("Speed", true));
    private final Setting<Boolean> hopWait = this.register(new Setting<Boolean>("Speed", true));
    private final Setting<Integer> startStage = this.register(new Setting<Integer>("Stage", 2, 0, 4));
    private final Setting<Boolean> setPos = this.register(new Setting<Boolean>("Speed", true));
    private final Setting<Boolean> setNull = this.register(new Setting<Boolean>("Speed", false));
    ...
    private final Setting<Boolean> setGroundNoLag = this.register(new Setting<Boolean>("Speed", true));
    private int stage = 1;
