...
public class Strafe
    ...
    private final Setting<Mode> mode = this.register(new Setting<Mode>("Speed", "Mode", 0.0, 0.0, Mode.NCP, 0));
    private final Setting<Boolean> limiter = this.register(new Setting<Boolean>("Speed", "SetGround", 0.0, 0.0, true, 0));
    private final Setting<Boolean> bhop2 = this.register(new Setting<Boolean>("Speed", "Hop", 0.0, 0.0, true, 0));
    private final Setting<Boolean> limiter2 = this.register(new Setting<Boolean>("Speed", "Bhop", 0.0, 0.0, false, 0));
    private final Setting<Boolean> noLag = this.register(new Setting<Boolean>("Speed", "NoLag", 0.0, 0.0, false, 0));
    ...
    private final Setting<Boolean> potion = this.register(new Setting<Boolean>("Speed", "Potion", 0.0, 0.0, false, 0));
    private final Setting<Boolean> wait = this.register(new Setting<Boolean>("Speed", "Wait", 0.0, 0.0, true, 0));
    private final Setting<Boolean> hopWait = this.register(new Setting<Boolean>("Speed", "HopWait", 0.0, 0.0, true, 0));
    private final Setting<Integer> startStage = this.register(new Setting<Integer>("Stage", 2, 0, 4));
    private final Setting<Boolean> setPos = this.register(new Setting<Boolean>("Speed", "SetPos", 0.0, 0.0, true, 0));
    private final Setting<Boolean> setNull = this.register(new Setting<Boolean>("Speed", "SetNull", 0.0, 0.0, false, 0));
    ...
    private final Setting<Boolean> setGroundNoLag = this.register(new Setting<Boolean>("Speed", "NoGroundLag", 0.0, 0.0, true, 0));
    private int stage = 1;
