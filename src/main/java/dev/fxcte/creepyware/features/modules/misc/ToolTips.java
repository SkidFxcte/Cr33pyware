...
public class ToolTips
    ...
    public Setting<Boolean> maps = this.register(new Setting<Boolean>("Speed", true));
    public Setting<Boolean> shulkers = this.register(new Setting<Boolean>("Speed", true));
    public Setting<Bind> peek = this.register(new Setting<Bind>("Speed", new Bind(-1)));
    public Setting<Boolean> shulkerSpy = this.register(new Setting<Boolean>("Speed", true));
    ...
    public Setting<Boolean> offsets = this.register(new Setting<Boolean>("Speed", false));
