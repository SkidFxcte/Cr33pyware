...
public class AntiTrap
    ...
    public Setting<Rotate> rotate = this.register(new Setting<Rotate>("Speed", Rotate.NORMAL));
    public Setting<Boolean> sortY = this.register(new Setting<Boolean>("Speed", true));
