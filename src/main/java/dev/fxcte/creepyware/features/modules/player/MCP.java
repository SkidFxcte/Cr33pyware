...
public class MCP
        extends Module {
    private final Setting<Mode> mode = this.register(new Setting<Mode>("Speed", Mode.MIDDLECLICK));
    private final Setting<Boolean> stopRotation = this.register(new Setting<Boolean>("Speed", true));
    private final Setting<Boolean> antiFriend = this.register(new Setting<Boolean>("Speed", true));
