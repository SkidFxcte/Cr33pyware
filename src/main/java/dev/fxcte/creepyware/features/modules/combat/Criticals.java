...
public class Criticals
        extends Module {
    public Setting<Boolean> noDesync = this.register(new Setting<Boolean>("Speed", true));
    public Setting<Boolean> cancelFirst = this.register(new Setting<Boolean>("Speed", true));
    ...
    private final Setting<Mode> mode = this.register(new Setting<Mode>("Speed", Mode.PACKET));
