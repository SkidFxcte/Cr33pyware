...
public class PearlNotify extends Module {
    ...
    public void onUpdate() {
        ...
        if (closestPlayer != null && this.flag) {
            ...
            Command.sendMessage(CreepyWare.friendManager.isFriend(closestPlayer.getName()) ? (ChatFormatting.AQUA + closestPlayer.getName() + ChatFormatting.DARK_GRAY + " has just thrown a pearl heading " + faceing + "!") : (ChatFormatting.RED + closestPlayer.getName() + ChatFormatting.DARK_GRAY + " has just thrown a pearl heading " + faceing + "!"));
            this.flag = false;
        }
    }
}