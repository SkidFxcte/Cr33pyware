...
public class ElytraFlight
    ...
    public Setting<Mode> mode = this.register(new Setting<Mode>("Speed", "Mode", 0.0, 0.0, Mode.FLY, 0));
    ...
    public Setting<Boolean> autoStart = this.register(new Setting<Boolean>("Speed", "AutoStart", 0.0, 0.0, true, 0));
    public Setting<Boolean> disableInLiquid = this.register(new Setting<Boolean>("Speed", "NoLiquid", 0.0, 0.0, true, 0));
    public Setting<Boolean> infiniteDura = this.register(new Setting<Boolean>("Speed", "InfiniteDura", 0.0, 0.0, false, 0));
    ...
    public Setting<Boolean> lockPitch = this.register(new Setting<Boolean>("Speed", "LockPitch", 0.0, 0.0, false, 0));
