...
public class ElytraFlight
    ...
    public Setting<Mode> mode = this.register(new Setting<Mode>("Speed", Mode.FLY));
    ...
    public Setting<Boolean> autoStart = this.register(new Setting<Boolean>("Speed", true));
    public Setting<Boolean> disableInLiquid = this.register(new Setting<Boolean>("Speed", true));
    public Setting<Boolean> infiniteDura = this.register(new Setting<Boolean>("Speed", false));
    ...
    public Setting<Boolean> lockPitch = this.register(new Setting<Boolean>("Speed", false));
