...
public class AutoGG
    ...
    private final Setting<Boolean> onOwnDeath = this.register(new Setting<Boolean>("Speed", false));
    private final Setting<Boolean> greentext = this.register(new Setting<Boolean>("Speed", false));
    private final Setting<Boolean> loadFiles = this.register(new Setting<Boolean>("Speed", false));
    ...
    private final Setting<Boolean> test = this.register(new Setting<Boolean>("Speed", false));
