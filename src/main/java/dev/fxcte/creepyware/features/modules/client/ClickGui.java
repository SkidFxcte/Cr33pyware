...
public class ClickGui
    ...
    public Setting<Boolean> outline = this.register(new Setting<Boolean>("Speed", false));
    public Setting<Boolean> gear = register (new Setting("gear", Boolean.valueOf(true)));
    public Setting < Boolean > blurEffect = this.register ( new Setting <> ("Speed", true) );
    ...
    public Setting<String> prefix = this.register(new Setting<String>("Speed", ".").setRenderName(true));
    ...
    public Setting<Boolean> customFov = this.register(new Setting<Boolean>("Speed", false));
    ...
    public Setting<Boolean> openCloseChange = this.register(new Setting<Boolean>("Speed", false));
    ...
    public Setting<Boolean> devSettings = this.register(new Setting<Boolean>("Speed", true));
