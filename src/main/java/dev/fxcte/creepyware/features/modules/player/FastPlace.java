...
public class FastPlace
    ...
    private final Setting<Boolean> obby = this.register(new Setting<Object>("Obsidian", Boolean.FALSE , v -> this.all.getValue() == false));
    private final Setting<Boolean> enderChests = this.register(new Setting<Object>("EnderChests", Boolean.FALSE , v -> this.all.getValue() == false));
    private final Setting<Boolean> crystals = this.register(new Setting<Object>("Crystals", Boolean.FALSE , v -> this.all.getValue() == false));
    private final Setting<Boolean> exp = this.register(new Setting<Object>("Experience", Boolean.FALSE , v -> this.all.getValue() == false));
    private final Setting<Boolean> Minecart = this.register(new Setting<Object>("Minecarts", Boolean.FALSE , v -> this.all.getValue() == false));
