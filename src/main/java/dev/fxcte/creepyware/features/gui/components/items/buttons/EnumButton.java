...
class EnumButton
    ...
    void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        CreepyWare.textManager.drawStringWithShadow(this.setting.getName() + " " + "\u00a77" + this.setting.currentEnumName(), this.x + 2.3f, this.y - 1.7f - (float) CreepyWareGui.getClickGui().getTextOffset(), this.getState() ? - 1 : - 5592406);
    }
