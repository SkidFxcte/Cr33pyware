...
class BurrowUtil implements Util {
    ...
    public static
    boolean placeBlock(final BlockPos pos, final EnumHand hand, final boolean rotate, final boolean packet, final boolean isSneaking) {
    ...
    public static
    List <EnumFacing> getPossibleSides(final BlockPos pos) {
    ...
    public static
    EnumFacing getFirstFacing(final BlockPos pos) {
    ...
    public static
    void faceVector(final Vec3d vec, final boolean normalizeAngle) {
    ...
    public static
    void rightClickBlock(final BlockPos pos, final Vec3d vec, final EnumHand hand, final EnumFacing direction, final boolean packet) {
        if (packet) {
    ...
    public static
    int findHotbarBlock(final Class clazz) {
        for (int i = 0; i < 9; ++ i) {
