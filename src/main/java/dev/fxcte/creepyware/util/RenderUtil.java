...
class RenderUtil
    ...
    void drawWaypointImage(BlockPos pos, GLUProjection.Projection projection, Color color, String name, boolean rectangle, Color rectangleColor) {
        ...
        float textWidth = CreepyWare.textManager.getStringWidth(text);
        CreepyWare.textManager.drawString(text, - (textWidth / 2.0f), - ((float) CreepyWare.textManager.getFontHeight() / 2.0f) + (float) CreepyWare.textManager.getFontHeight() / 2.0f, color.getRGB(), false);
        GlStateManager.translate(- projection.getX(), - projection.getY(), 0.0);
        GlStateManager.popMatrix();
    }
    ...
    public static
    void drawBoundingBoxBottomBlockPosXInMiddle2(BlockPos bp, float width, int r, int g, int b, int alpha) {
        GlStateManager.pushMatrix();
        GlStateManager.enableBlend();
        GlStateManager.disableDepth();
        GlStateManager.tryBlendFuncSeparate(770, 771, 0, 1);
    ...
    public static
    void drawBoundingBoxBottomBlockPosXInMiddle(BlockPos bp, float width, int r, int g, int b, int alpha) {
        GlStateManager.pushMatrix();
        GlStateManager.enableBlend();
        GlStateManager.disableDepth();
        GlStateManager.tryBlendFuncSeparate(770, 771, 0, 1);
    ...
    void drawText(AxisAlignedBB pos, String text) {
        ...
        GlStateManager.disableDepth();
        GlStateManager.translate(- ((double) CreepyWare.textManager.getStringWidth(text) / 2.0), 0.0, 0.0);
    ...
    void drawProjectedText(GLUProjection.Projection projection, float addX, float addY, String text, Color color, boolean shadow) {
        if (projection.getType() == GLUProjection.Projection.Type.INSIDE) {
            GlStateManager.pushMatrix();
            GlStateManager.translate(projection.getX(), projection.getY(), 0.0);
            CreepyWare.textManager.drawString(text, - ((float) CreepyWare.textManager.getStringWidth(text) / 2.0f) + addX, addY, color.getRGB(), shadow);
            GlStateManager.translate(- projection.getX(), - projection.getY(), 0.0);
            GlStateManager.popMatrix();
        }
    }
