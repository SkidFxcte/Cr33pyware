...
public abstract class Biome extends net.minecraftforge.registries.IForgeRegistryEntry.Impl<Biome>
{
    ...
    public static final NoiseGeneratorPerlin TEMPERATURE_NOISE = new NoiseGeneratorPerlin(new Random(1234L), 1);
    public static final NoiseGeneratorPerlin GRASS_COLOR_NOISE = new NoiseGeneratorPerlin(new Random(2345L), 1);
    public static final WorldGenDoublePlant DOUBLE_PLANT_GENERATOR = new WorldGenDoublePlant();
    /** The tree generator. */
    public static final WorldGenTrees TREE_FEATURE = new WorldGenTrees(false);
    /** The big tree generator. */
    public static final WorldGenBigTree BIG_TREE_FEATURE = new WorldGenBigTree(false);
    /** The swamp tree generator. */
    public static final WorldGenSwamp SWAMP_FEATURE = new WorldGenSwamp();
    ...
    @Nullable
    public final String baseBiomeRegName;
    ...
    public List<Biome.SpawnListEntry> spawnableMonsterList = Lists.<Biome.SpawnListEntry>newArrayList();
    /** Holds the classes of any creature that can be spawned in the biome as friendly creature. */
    public List<Biome.SpawnListEntry> spawnableCreatureList = Lists.<Biome.SpawnListEntry>newArrayList();
    /** Holds the classes of any aquatic creature that can be spawned in the water of the biome. */
    public List<Biome.SpawnListEntry> spawnableWaterCreatureList = Lists.<Biome.SpawnListEntry>newArrayList();
    public List<Biome.SpawnListEntry> spawnableCaveCreatureList = Lists.<Biome.SpawnListEntry>newArrayList();
