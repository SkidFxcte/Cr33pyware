...
public class BedAura
    ...
    Setting<Boolean> rotate = this.register(new Setting<Boolean>("Rotate", true));
    Setting<Boolean> dimensionCheck = this.register(new Setting<Boolean>("DimensionCheck", true));
