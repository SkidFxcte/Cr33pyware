...
public class Speedmine
    ...
    public void onTick() {
        if (this.currentPos != null) {
            ...
            if (Speedmine.mc.player != null && this.silentSwitch.getValue().booleanValue() && this.timer.passedMs((int) (2000.0f * CreepyWare.serverManager.getTpsFactor())) && this.getPickSlot() != -1) {
    ...
    public void onRender3D(Render3DEvent event) {
        if (this.render.getValue().booleanValue() && this.currentPos != null) {
            Color color = new Color(this.timer.passedMs((int) (2000.0f * CreepyWare.serverManager.getTpsFactor())) ? 0 : 255, this.timer.passedMs((int) (2000.0f * CreepyWare.serverManager.getTpsFactor())) ? 255 : 0, 0, 255);
